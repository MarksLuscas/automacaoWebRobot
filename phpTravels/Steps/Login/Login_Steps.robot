...
E realize o cadastro
    ...
    Wait Until Element Is Visible      ${Login.Button_Country}      10
    Click Element                      ${Login.Button_Country}  
    Wait Until Element Is Visible      ${Login.Input_Country}
    Input Text                         ${Login.Input_Country}       Brazil   
    Wait Until Element Is Visible      ${Login.Button_Brazil}
    Click Element                      ${Login.Button_Brazil}          
